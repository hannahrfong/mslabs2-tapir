...
class ExpConfig(PATH):
    ...
    def __init__(self):
        ...
        # Dataset list
        self.SEQ_LABELLING = ['raddle-noisy-slot', 'snips-noisy-slot', 'atis-slot', 'snips-slot', 'multilingual', 'movie',
                              'chunk-conll2003', 'pos-conll2003', 'ner-conll2003',
                              'pos-ud-ewt']

        # Task that uses BIO scheme
        self.BIO_SCHEME = ['raddle-noisy-slot', 'snips-noisy-slot', 'atis-slot', 'snips-slot', 'multilingual', 'movie', 'chunk-conll2003', 'ner-conll2003']

        # Optimizer
        self.OPT = ''
        self.OPT_PARAMS = {}

        #TODO: HANNAH ADDED THIS
